...
namespace KushBot.Migrations
{
    ...
    [Migration("20241028205230_plot-type-discrimination")]
    partial class plottypediscrimination
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KushBot.DataClasses.ChannelPerms", b =>
                {
                    ...
                    b.HasIndex("PermitsBoss")
                        .IsUnique()
                        .HasFilter("[PermitsBoss] = 1");

                    b.HasIndex("PermitsVendor")
                        .IsUnique()
            ...
            modelBuilder.Entity("KushBot.DataClasses.Garden", b =>
                {
                    b.HasBaseType("KushBot.DataClasses.Plot");

                    b.HasDiscriminator().HasValue(1);
                });

            modelBuilder.Entity("KushBot.DataClasses.Hatchery", b =>
                {
                    b.HasBaseType("KushBot.DataClasses.Plot");
            ...
            modelBuilder.Entity("KushBot.DataClasses.Quarry", b =>
                {
                    b.HasBaseType("KushBot.DataClasses.Plot");
