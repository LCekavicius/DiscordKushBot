...
//            DiscordBotService.IgnoredUsers.Add(Context.User.Id, DateTime.Now.AddMilliseconds(DiscordBotService.GambleDelay + 150));
...
//                {
//                    if (Data.Data.GetUserItems(Context.User.Id).Count >= DiscordBotService.ItemCap)
//                    {
...
//                if (Data.Data.GetLostBapsMN(Context.User.Id) >= DiscordBotService.Quests[1].GetCompleteReq(Context.User.Id) && QuestIndexes.Contains(1))
//                {
//                    await DiscordBotService.CompleteQuest(1, QuestIndexes, Context.Channel, Context.User);
//                }


//                if (WeeklyQuests.Contains(1))
//                {
//                    QuestOld q = DiscordBotService.WeeklyQuests[1];
...
//                    {
//                        await DiscordBotService.CompleteWeeklyQuest(1, Context.Channel, Context.User);
//                    }
//                }
//                if (WeeklyQuests.Contains(3))
//                {
//                    QuestOld q = DiscordBotService.WeeklyQuests[3];
//                    int lostbapsw = Data.Data.GetLostBapsWeekly(Context.User.Id);
//                    if (lostbapsw < q.GetCompleteReq(Context.User.Id) && (lostbapsw + amount) >= q.GetCompleteReq(Context.User.Id))
//                    {
//                        await DiscordBotService.CompleteWeeklyQuest(3, Context.Channel, Context.User);
//                    }
//                }
//            }
//            else
...
//                if (Data.Data.GetWonBapsMN(Context.User.Id) >= DiscordBotService.Quests[0].GetCompleteReq(Context.User.Id) && QuestIndexes.Contains(0))
//                {
//                    await DiscordBotService.CompleteQuest(0, QuestIndexes, Context.Channel, Context.User);
//                }

//                if (WeeklyQuests.Contains(0))
//                {
//                    QuestOld q = DiscordBotService.WeeklyQuests[0];
...
//                    {
//                        await DiscordBotService.CompleteWeeklyQuest(0, Context.Channel, Context.User);
//                    }
//                }

//                if (WeeklyQuests.Contains(2))
//                {
//                    QuestOld q = DiscordBotService.WeeklyQuests[2];
//                    int wonbapsw = Data.Data.GetWonBapsWeekly(Context.User.Id);
//                    if (wonbapsw < q.GetCompleteReq(Context.User.Id) && (wonbapsw + won) >= q.GetCompleteReq(Context.User.Id))
//                    {
//                        await DiscordBotService.CompleteWeeklyQuest(2, Context.Channel, Context.User);
//                    }
//                }
//            }
